...
1. Ensure that you have installed the required dependencies and added the OpenAI API key to the `.env` file. inside Chatbot/app folder and paste folowing:
   ```
   OPENAI_API_KEY=
   HUGGINGFACEHUB_API_TOKEN=
   ```

2.  Run the followings commands inside chatbot directory:
   ```
...
3. Go to `http://127.0.0.1:8005/chatbot/`
